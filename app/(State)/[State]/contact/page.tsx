              ...
              <div className=" flex w-full flex-col justify-around gap-3   ">
                <div className="">
                  ...
                  <p className="mt-10  text-justify">
                    Take the first step toward hassle-free plumbing services in{" "}
                    {Data.name} with Ben Franklin Plumbing. Whether you&apos;re
                    dealing with a minor leak, planning a new installation, or
                    need a full system upgrade, we’re here to provide you with a
                    transparent, no-obligation estimate tailored to your
                    specific needs.
                  </p>
                </div>
              </div>
